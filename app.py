...
def create_connection():
    ...
    db = mysql.connector.connect(user='root', password='Mysql@28', host='localhost', port=3306, database='hospitalmanagement', auth_plugin='mysql_native_password')
    return db

def create_database(db):
    """Create the 'hospitalmanagement' database if it doesn't exist."""
    cursor = db.cursor()
...
def main():
    # Title and sidebar
    st.title("Hospital Management System :hospital:")
    ...
    menu = ["Home","Add Patient Record","Show Patient Records", "Search and Edit Patient","Delete Patient's Record",
    ...
    elif options == "Delete Patient's Record":
         st.subheader("Search a patient to delete")
